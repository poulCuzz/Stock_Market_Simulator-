        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Fill in:</h1>
                ...
                <form:form method="post" modelAttribute="company">
                    ...
                    <form:input path="numberOfStocks" type="number" id="numberOfStocks" value="0" min="0" step="1" /><label for="numberOfStocks">How many stocks?</label><br/>
                    <input class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" type="submit" value="Save">
                </form:form>
